...
var init_src2 = __esm({
  "packages/database/src/index.ts"() {
    ...
    init_env();
    init_schema2();
    client = src_default(env.DATABASE_URL, { max: 1, idle_timeout: 15 });
...
// apps/api/src/routes/ai.ts
var aiApp = new Hono2();
var ai = new GoogleGenAI({ apiKey: env2.GEMINI_API_KEY });
...
var ai2 = new GoogleGenAI2({ apiKey: env2.GEMINI_API_KEY });
